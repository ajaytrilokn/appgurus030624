...
function twentytwenty_register_scripts() {
	...
	if (!is_page_template( 'templates/free-consultation.php'))
	{
		...
		{ 
			...
			wp_enqueue_style( 'appgurus-bootstrap5', get_template_directory_uri() . '/homeassets/css/bootstrap-5.0.2/css/bootstrap.min.css' );
			wp_enqueue_style( 'appgurus-fontfamily', get_template_directory_uri() . '/homeassets/font/font-family/stylesheet.css' );
			wp_enqueue_style( 'appgurus-animations', get_template_directory_uri() . '/homeassets/css/animations.css' );
			wp_enqueue_style( 'appgurus-updated-slick', get_template_directory_uri() . '/homeassets/css/slick.min.css' );
			wp_enqueue_style( 'appgurus-updated-style', get_template_directory_uri() . '/homeassets/css/style.css' );
			wp_enqueue_style( 'appgurus-updated-media', get_template_directory_uri() . '/homeassets/css/media.css' );
			wp_enqueue_style( 'appgurus-updated-footer', get_template_directory_uri() . '/homeassets/css/footer.css' );
			wp_enqueue_style( 'appgurus-updated-header', get_template_directory_uri() . '/homeassets/css/header.css' );

			wp_enqueue_script( 'appgurus-updated-jquery', get_template_directory_uri() . '/homeassets/js/jquery-3.6.0/jquery.min.js', array(), '1.0',  true );
